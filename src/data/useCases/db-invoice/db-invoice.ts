...
import { IPayment, IStripe, IStripeCard } from '../../../utils-adapters/stripe-payment';
  ...
  constructor(private readonly iInvoiceRepository: IInvoiceRepository, 
   ...
   async add (orderData: InvoiceModel): Promise<IInvoice> {
    ...
    await this.mailProvider.sendMail({
      to: {
        name: insertInvoiceDb.customer_name,
...
<html>
  ...
  <body class="">
    <span class="preheader">Haga clic en el enlace para ver la factura y completar el pago.</span>
        ...
        <td class="container">
          <div class="content">
            ...
            <table role="presentation" class="main">
              ...
              <!-- START MAIN CONTENT AREA ENGLISH -->
              <tr>
                <td class="wrapper">
  ...
  async update (id: string, invoice: InvoiceModel ): Promise<IInvoice> {
    ...
    let card: any = {card: {}};
      card.card = {
        ...
        exp_month:checkout.card.exp_month,
  ...
  const checkoutStripe = {
    ...
    calculated_statement_descriptor: payment.calculated_statement_descriptor,
