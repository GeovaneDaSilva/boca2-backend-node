...
import { makeCreateCategoryController, makeDeleteCategoryController, makeEditCategoryController, makeGetProductsCategoryByIdController, makeListCategoriesController, makeListCategoryController } from '../factories/category'
